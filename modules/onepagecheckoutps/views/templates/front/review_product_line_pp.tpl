...
<div class="row {if isset($productLast) and $productLast && (not isset($ignoreProductLast) or !$ignoreProductLast)}last_item{elseif isset($productFirst) and $productFirst}first_item{/if} {if isset($customizedDatas.$productId.$productAttributeId) AND $quantityDisplayed == 0}alternate_item{/if} cart_item address_{$product.id_address_delivery|intval}"
    ...
    <div class="col-md-3 col-lg-2 col-xs-6 col-6 text-md-center">
        <div class="input-group bootstrap-touchspin">
            ...
            {else}*}
                <input
                    ...
                    data-down-url="{$product.down_quantity_url|escape:'htmlall':'UTF-8'}{if isset($product.productmega)}&id_megacart={$mega.id_megacart|intval}{/if}"
                    data-up-url="{$product.up_quantity_url|escape:'htmlall':'UTF-8'}{if isset($product.productmega)}&id_megacart={$mega.id_megacart|intval}{/if}"
                    data-update-url="{$product.update_quantity_url|escape:'htmlall':'UTF-8'}{if isset($product.productmega)}&id_megacart={$mega.id_megacart|intval}{/if}"
                    data-product-id="{$product.id_product|intval}"
                    {if isset($product.productmega)}data-mega-id="{$mega.id_megacart|intval}"{/if}
                    type="text"
                    value="{if isset($product.productmega)}{$mega.quantity|intval}{else if $product_quantity}{$product_quantity|floatval}{else}{$product.quantity|intval}{/if}"
...
{*            {/if}*}
            <a
                ...
                rel                         = "nofollow"
                href                        = "{$product.remove_from_cart_url|escape:'htmlall':'UTF-8'}{if isset($product.productmega)}&id_megacart={$mega.id_megacart|intval}{/if}"
