...
<style>
    ...
    {if isset($CONFIGS.OPC_THEME_VOUCHER_BUTTON_TEXT) and not empty($CONFIGS.OPC_THEME_VOUCHER_BUTTON_TEXT)}
        #onepagecheckoutps #list-voucher-allowed #submitAddDiscount, #onepagecheckoutps #list-voucher-allowed #submitAddDiscount > span {ldelim}
    ...
    {if isset($amazonpay_session_opc)}
        #panel_address_delivery #address_card_new,
        #panel_address_delivery .card-header,
        #onepagecheckoutps_step_three #payment_method_container,
        #onepagecheckoutps_step_review #order-detail-content .amazonPayButton,
        #panel_address_delivery .address_card .footer_card {ldelim}
            display: none;
        {rdelim}
    {/if}
</style>
