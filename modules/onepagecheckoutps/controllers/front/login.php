...
{
    //public $php_self = 'module-onepagecheckoutps-login'; se quita para no dar lios de poner el parametro "ajax=1" en las URL.
    ...
    public function initContent()
    {
        ...
        if ($success && !empty($return_data) && property_exists($return_data, 'email')) {
            ...
            if (!Validate::isLoadedObject($customer)) {
                ...
                if ($this->module->isCheckoutBetaEnabled()) {
                ...
                if ($this->module->isCheckoutBetaEnabled()) {
                    ...
                    $myaccount->setCustomer($customer);
                    $myaccount->singInCustomer();
                } else {
