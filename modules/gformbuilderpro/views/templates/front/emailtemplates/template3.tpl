...
<tbody>
    <tr>
        <td style="height: 70px;background: #9C9CE8;"></td>
    </tr>
    <tr>
                ...
                <tr>
                    <td style="padding: 30px;">
                        <table style="width: 100%;background: #fff;">
                            {literal}
                            <tr>
                        		<td colspan="2" class="logo" style="border-bottom:2px solid #E9EAF2;padding:7px 0; text-align:center;">
                            ...
                            <tr>
                                <td colspan="2" style="border-top:2px solid #E9EAF2;padding:10px 0!important">
                                    <table style="width:100%;">
                                        <tr>
                                            <td>
                                                <p><strong>{/literal}{l s='Contact Us' mod='gformbuilderpro'}: {literal}</strong></p>
