...
tinymce.ThemeManager.add("modern", function(a) {
    ...
    l.renderUI = function(b) {
        ...
        if (c) {
            var d = m.skin_url;
            baseUri = a.documentBaseURI.settings.base_uri.source+'/../../../../';
            d = d ? a.documentBaseURI.toAbsolute(d) : baseUri+"views/css/front/skins/lightgray/" + c, tinymce.Env.documentMode <= 7 ? b.skinUiCss =  baseUri+"views/css/front/skins/lightgray/skin.ie7.min.css" : b.skinUiCss =  baseUri+"views/css/front/skins/lightgray/skin.min.css", a.contentCSS.push( baseUri+"views/css/front/skins/lightgray/content" + (a.inline ? ".inline" : "") + ".min.css")
        }
