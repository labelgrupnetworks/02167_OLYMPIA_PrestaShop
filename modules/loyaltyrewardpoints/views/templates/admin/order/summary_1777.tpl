...
<div id="lrp-admin-order-summary-panel" class="card mt-2">
    ...
    <div class="card-body">
        <h3>{l s='Redeemed' mod='loyaltyrewardpoints'}</h3>

        <div class="lrp-boxes {if $redeemed_points eq 0}disabled{/if}">
            <div class="lrp-box">
        ...
        <h3 style="margin-top: 20px;">{l s='Rewarded' mod='loyaltyrewardpoints'}</h3>
