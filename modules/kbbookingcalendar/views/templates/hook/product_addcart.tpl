<div class="kb-booking-product-block" style="display: none;">
    <h5 class="h5">
        {if $product_type =='appointment'}
            {l s='Book Appointment' mod='kbbookingcalendar'}
        {elseif $product_type =='daily_rental'}
            {l s='Book Daily Rental' mod='kbbookingcalendar'}
    ...
    <div class="col-lg-12 kb-booking-product-price-block">
        <span class="kb-booking-product-price">
        ...
        {if $product_type == 'hotel_booking'}
            ...
            {/if}
        {/if}
        {*        {if $booking_product_details['period_type']  == 'date'}*}
        {if $product_type != 'hotel_booking'}
...
{if $product_type != 'hotel_booking'}
    <div style="text-align: center;">
        <button type="submit" class="btn btn-primary" id="kb-submit-booking-product-cart"><i class="material-icons">shopping_cart</i>&nbsp;{l s='Book Now' mod='kbbookingcalendar'}</button>
    </div>
{elseif $product_type == 'hotel_booking'}
    ...
    <div style="text-align: center;">
        ...
        {*        <button type="button" class="btn btn-primary" onclick="searchRoomByCategory();"><i class="material-icons">search</i>&nbsp;{l s='Search' mod='kbbookingcalendar'}</button>*}
    </div>
{/if}
