...
<div class="elementor-products">
        {if $view == 'carousel_s' || $view == 'carousel'}
            ...
            <div class="products elementor-products-carousel swiper-products-carousel swiper-container products-grid  {$cls_fix_classes}"  data-slider_options='{$options|@json_encode nofilter}'>
        ...
        {foreach from=$products item="product"}
            ...
            {elseif $view == 'carousel_s'}
                {if $page['page_name'] == 'index' && $options['slidesToShow'] == 1 && $options['itemsPerColumn'] == 1}
                    <div class="swiper-slide"> {include file="catalog/_partials/miniatures/product-small.tpl" product=$product elementor=true carousel=true homeoneproduct=true} </div>
                {else}
